                    ...
                    for x in 0..MAX_X {
                        ...
                        match maybe_tile {
                            Ok(tile) => {
                                ...
                                graphics::draw(ctx, &surface, DrawParam::default().dest(Point2::new(44.0 * x as f32, (44.0 + 16.0) * y as f32))).expect("Failed to blit texture");
                            },
                            _ => ()
                        };
                        let label = Text::new(format!("{}", index));
                        graphics::draw(ctx, &label, (Point2::new(44.0 * x as f32, ((44.0 + 16.0) * y as f32) + 44.0), graphics::WHITE));
